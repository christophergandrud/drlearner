...
linear projection of the CATE given observed covariates $A$ for unit $i$ $\widehat{{\tau}_{BLP}} (A_{i})$, where $A \subseteq X$.
...
only apply a treatment if the BLP is greater than some value $\gamma$:
