...
Estimation to enable approximately optimal policy targeting using best linear 
projections.
...
- Construct estimates ($\hat{\mu}_0,\hat{\mu}_1$) of the regression functions ($\mu_0,\mu_1$) using $D^n_1$.
