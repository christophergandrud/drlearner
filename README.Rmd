...
[Kennedy (2022, 10)](https://arxiv.org/pdf/2004.14497.pdf) proposes using sample slitting to estimate the conditional average treatment effects using the following algorithm:
